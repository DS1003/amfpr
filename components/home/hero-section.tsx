...
export function HeroSection() {
  return (
    <section className="relative bg-[#FAF8F5] pt-32 lg:pt-40 pb-12 lg:pb-24">
      <div className="mx-auto max-w-screen-2xl px-6 lg:px-8">
        <div className="relative min-h-[600px] lg:min-h-[700px] flex flex-col lg:flex-row overflow-hidden rounded-[2.5rem] bg-white border border-border/50 shadow-xl">
          ...
          <div className="w-full lg:w-[45%] bg-[#0E3B2E] flex items-center z-20 order-2 lg:order-1 relative">
            ...
            <div className="px-8 py-16 lg:px-16 lg:py-24 w-full">
              <MotionWrapper delay={0}>
                <div className="flex items-center gap-3 mb-6">
                  <HeartHandshake className="size-5 text-accent" />
                  <span className="text-xs font-bold tracking-widest text-accent uppercase font-serif italic">
              ...
              <MotionWrapper delay={150}>
                <h1 className="font-serif text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl leading-[1.1] mb-6">
                  Agir <span className="text-accent underline decoration-accent/30 underline-offset-8">Ensemble</span> <br />
                  Pour Un <br />
                  Futur Meilleur
                </h1>
              </MotionWrapper>
              ...
              <MotionWrapper delay={300}>
                <p className="text-lg leading-relaxed text-white/80 max-w-md mb-10">
              ...
              <MotionWrapper delay={450}>
                <div className="flex flex-wrap gap-4 items-center">
                  <Button
                    asChild
                    className="bg-white/10 backdrop-blur-sm border border-white/20 text-white hover:bg-accent hover:text-white rounded-2xl px-8 h-14 text-xs font-bold uppercase tracking-widest flex items-center gap-3 transition-all"
                  >
                    <Link href="/a-propos">
                      Découvrir Plus
                  ...
                  <Button
                    asChild
                    className="bg-accent text-accent-foreground hover:bg-white hover:text-primary rounded-2xl px-8 h-14 text-xs font-bold uppercase tracking-widest flex items-center gap-3 shadow-xl shadow-accent/10 transition-all"
                  >
