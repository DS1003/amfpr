    ...
    return (
        <div className="space-y-8 pb-10">
            <div>
                ...
                <h1 className="font-serif text-3xl font-bold text-primary tracking-tight">Ajouter une activité</h1>
                <p className="mt-2 text-muted-foreground">Créez un nouvel article pour partager les actions de l'amicale.</p>
            </div>
